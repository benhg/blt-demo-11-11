...
int main() {
    ...
    for (int step = 0; step < MAX_STEPS; step++) {
        ...
        // Optional: Add a delay to make the simulation run slower for better visualization
        usleep(500000);  // Delay of 500ms (requires #include <unistd.h> on UNIX-based systems)
    }
